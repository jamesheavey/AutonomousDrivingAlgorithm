...
_HSV_COLOR_RANGES = {
    _BLUE: (np.array([115, 50, 50], dtype=np.uint8), np.array([130, 255, 255], dtype=np.uint8)),
    _ORANGE: (np.array([0, 50, 50], dtype=np.uint8), np.array([15, 255, 255], dtype=np.uint8)),
    _YELLOW: (np.array([25, 50, 50], dtype=np.uint8), np.array([40, 255, 255], dtype=np.uint8))
}
